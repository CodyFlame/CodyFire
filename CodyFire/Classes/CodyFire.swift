...
open class CodyFire: _Serverable {
    public class var shared: CodyFire { _sharedInstance }
    ...
    var _reachabilityAdapter: ReachabilityAdapter?
...
//        get { shared.fillHeaders }
//        set { shared.fillHeaders = newValue }
//    }
//
//    public var fillCodableHeaders: FillCodableHeaders?
//    public static var fillCodableHeaders: FillCodableHeaders? {
//        get { shared.fillCodableHeaders }
//        set { shared.fillCodableHeaders = newValue }
//    }
//
//
//
////    public var ws: WS { WS.shared }
//
